...
We have organized and preprocessed the most commonly used public evaluation datasets in the current RAG field and will soon release a unified version on Hugging Face, allowing users to download and use them directly without additional processing.
