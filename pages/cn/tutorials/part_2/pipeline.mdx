---
title: "掌握 UltraRAG 的流程语言：Pipeline 编排基础与结构详解"
icon: "square-terminal"
---

## 什么是 Pipeline？

在 UltraRAG 中，Pipeline 是你定义“推理任务如何执行”的流程脚本。它像一个“任务计划表”或“工作流蓝图”，用来明确告诉系统每一步该做什么、怎么做、做完后怎么走下一步。
...
Pipeline 的设计目标是：让复杂的 RAG 流程结构清晰、灵活、模块化，并通过 YAML 配置实现零代码编排。

## Pipeline 的构成核心

在 UltraRAG 中，Pipeline 是以 YAML 文件形式编写的流程配置，它由两个顶层结构组成：
