---
title: "循环型RAG Workflow实战 (IterRetGen)"
---

本节将带你实现一种典型的迭代推理能力的 RAG 工作流，IterRetGen。该流程支持基于模型输出反复更新查询，从而逐步收敛至更优的答案。

> 原始论文详见：https://arxiv.org/pdf/2305.15294
...
### Step 2.1 :实现custom.iterretgen_nextquery 

IterRetGen通过拼接查询query和当前轮次生成的答案作为本轮查询，为此在 servers/custom/src/custom.py 中添加如下代码：
