...
<Tip>如果尚未安装 UR-2.0，请先参考 [Installation](/pages/cn/getting_started/installation)。</Tip>

<Tip>更复杂的 RAG 实践，请前往 [Tutorials](/pages/cn/tutorials/part_1/server_index) 查看。</Tip>
...
```yaml
# examples/parameters/sayhello_parameter.yaml
sayhello:
